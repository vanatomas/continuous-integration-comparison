...
|[Robot Sweatshop](https://github.com/JScott/robot_sweatshop) | <ul><li>Test on every environment</li></ul><ul><li>Containerization</li></ul><ul><li>Self-hosted/faster</li></ul> | <ul><li>Time sink</li><li>No community support</li></ul> | Free |
